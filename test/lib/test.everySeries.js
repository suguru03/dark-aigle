...
parallel('everySeries', () => {
  ...
  it('should execute in series', async () => {
    ...
    const res = await Promise.everySeries(collection, iterator);
  ...
  it('should return an empty array if collection is an empty array', async () => {
    ...
    const res = await Promise.everySeries([], iterator);
    assert.strictEqual(res, true);
  });
  ...
  it('should return an empty array if collection is string', async () => {
    ...
    const res = await Promise.everySeries('test', iterator);
    assert.strictEqual(res, true);
  });
  it('should throw TypeError', async () => {
    ...
    try {
      await Promise.everySeries(collection, iterator);
      assert.fail();
    } catch (e) {
...
parallel('#everySeries', () => {
  ...
  it('should execute in series', async () => {
    ...
    const res = await Promise.resolve(collection).everySeries(iterator);
    assert.strictEqual(res, false);
    assert.deepEqual(order, [
      [0, 1],
      [1, 4]
  ...
  it('should throw TypeError', async () => {
    ...
    try {
      await Promise.resolve(collection).everySeries(iterator);
    } catch (e) {
      assert.ok(e instanceof TypeError);
    }
  });
