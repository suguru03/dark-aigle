...
function createEachWithKey(createResult, createCallbackHandler) {
  ...
  function callArrayEach(array, iterator) {
    ...
    return new Promise((resolve, reject) => {
      let i = -1;
      const createCallback = createCallbackHandler(l, result, resolve, array);
      while (++i < l) {
        const promise = call3(iterator, array[i], i, array);
        if (promise === errorObj) {
          return reject(errorObj.e);
  ...
  function callObjectEach(object, iterator) {
    ...
    return new Promise((resolve, reject) => {
      let i = -1;
      const createCallback = createCallbackHandler(l, result, resolve, object, keys);
      while (++i < l) {
        const key = keys[i];
        const promise = call3(iterator, object[key], key, object);
        if (promise === errorObj) {
...
function createEachSeriesWithKey(createResult, createCallbackHandler) {
  ...
  function callArrayEach(array, iterator) {
    ...
    return new Promise((resolve, reject) => {
      let i = -1;
      const createCallback = createCallbackHandler(l, result, resolve, iterate, array);
      iterate();
      function iterate() {
        const promise = call3(iterator, array[++i], i, array);
        if (promise === errorObj) {
  ...
  function callObjectEach(object, iterator) {
    ...
    return new Promise((resolve, reject) => {
      let i = -1;
      const createCallback = createCallbackHandler(l, result, resolve, iterate, object, keys);
      iterate();
      function iterate() {
        const key = keys[++i];
        const promise = call3(iterator, object[key], key, object);
